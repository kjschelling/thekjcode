    ...
    return (<div className="full bg-biege">
        <div className="pb-7 mx-auto">
            <div className=" container mx-auto p-7 mb-2">
                ...
                <a href="https://drive.google.com/file/d/19H8b4UBCTSieEDJ399JORLIXpfsMD_Gt/view?usp=sharing" class="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-purple-500 rounded-full shadow-md group">
